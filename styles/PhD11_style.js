...
var styleCache_PhD11={}
var style_PhD11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (!styleCache_PhD11[key]){
        ...
        styleCache_PhD11[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PhD11[key]];
